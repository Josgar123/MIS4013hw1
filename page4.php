...
<button type="button" class="btn btn-secondary">Foods</button>
<button type="button" class="btn btn-success">Theaters</button>
<button type="button" class="btn btn-danger">Customers</button>
